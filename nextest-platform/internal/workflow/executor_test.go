...
// mockUnifiedExecutor is a simple mock for testing
type mockUnifiedExecutor struct{}

func (m *mockUnifiedExecutor) Execute(testCase *testcase.TestCase) *testcase.TestResult {
...
func setupTestDB(t *testing.T) *gorm.DB {
	...
	// Auto migrate all models including workflow and multi-tenancy tables
	err = db.AutoMigrate(
		&models.Tenant{},
		&models.Project{},
		&models.TenantMember{},
	...
	// Create default tenant and project for testing
...
func TestWorkflowExecutor_SimpleWorkflow(t *testing.T) {
	...
	// For tests, we can use nil since we're not executing test-case type steps
	var unifiedExecutor *testcase.UnifiedTestExecutor = nil
	...
	// Execute workflow
	result, err := executor.Execute("test-workflow-1", workflowDef, nil)
...
func TestWorkflowExecutor_ParallelSteps(t *testing.T) {
	...
	result, err := executor.Execute("parallel-workflow", workflowDef, nil)
...
func TestWorkflowExecutor_SequentialSteps(t *testing.T) {
	...
	result, err := executor.Execute("sequential-workflow", workflowDef, nil)
...
func TestWorkflowExecutor_CycleDetection(t *testing.T) {
	...
	result, err := executor.Execute("cycle-workflow", workflowDef, nil)
...
func TestWorkflowExecutor_StepFailure(t *testing.T) {
	...
	result, err := executor.Execute("failure-workflow", workflowDef, nil)
...
func TestWorkflowExecutor_ContinueOnError(t *testing.T) {
	...
	result, err := executor.Execute("continue-workflow", workflowDef, nil)
...
func TestWorkflowExecutor_RetryLogic(t *testing.T) {
	...
	start := time.Now()
	result, err := executor.Execute("retry-workflow", workflowDef, nil)
...
func TestWorkflowExecutor_TestCaseAction(t *testing.T) {
	...
	result, err := executor.Execute("testcase-workflow", workflowDef, nil)
...
func TestWorkflowExecutor_StepLogging(t *testing.T) {
	...
	result, err := executor.Execute("logging-workflow", workflowDef, nil)
	require.NoError(t, err)
...
func TestWorkflowExecutor_StepExecutionRecords(t *testing.T) {
	...
	result, err := executor.Execute("tracking-workflow", workflowDef, nil)
	require.NoError(t, err)
